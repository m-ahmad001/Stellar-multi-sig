  ...
  return (
    <div className="keypair-generator">
      ...
      <p className="description">
        Generate test keypairs for multi-sig setup. Remember to fund accounts on
        testnet!
      </p>

      <div className="generator-controls">
        <button
          onClick={() => generateKeypairs(5)}
          disabled={isGenerating}
          className="generate-btn"
        >
          {isGenerating ? "Generating..." : "Generate 5 Test Keypairs"}
        </button>

        {keypairs.length > 0 && (
          <button onClick={() => setKeypairs([])} className="clear-btn">
            Clear All
          </button>
        )}
      </div>
      ...
      {keypairs.length > 0 && (
        <div className="keypairs-list">
          <div className="keypairs-header">
            ...
            <p className="warning">
              ⚠️ These are test keys only! Never use generated keys for real
              funds.
            </p>
          </div>
      ...
      <div className="generator-info">
        ...
        <div className="security-note">
          <h5>🔒 Security Note:</h5>
          <p>
            These keypairs are generated client-side and are suitable for
            testing only. For production use, generate keypairs securely and
